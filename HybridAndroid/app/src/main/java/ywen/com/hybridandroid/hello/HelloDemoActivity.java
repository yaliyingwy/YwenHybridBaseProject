 ...
 */
public class HelloDemoActivity extends AppCompatActivity implements HybridCore, HybridNav {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HybridWebView hybridWebView = (HybridWebView) findViewById(R.id.view);
        hybridWebView.loadPage(this, "hello-demo.html");
    }
